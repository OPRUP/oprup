...
export class PurchaseNavService implements OnDestroy {
    ...
    ////////////add your routes
{
    title: 'فواتير الشراء',
          titleEn: 'Purchasing',
          path: '/purchase/purchasing/purchasing',
  ...
  {
        title: 'الموردون', titleEn:"Vendor", path: '/purchase/vendor/vendor', img:'../../../../assets/images/icons/ic03.png',  icon: '', type: 'link', active: false,
      },
