...
import { Menu, SettingService } from '../../services/setting.service';

@Component({
  selector: 'app-setting-sidbar',
  templateUrl: './setting-sidbar.component.html',
  styleUrls: ['./setting-sidbar.component.scss']
})
export class SettingSidbarComponent implements OnInit {
  ...
  constructor(
    ...
    this.settingService.items.subscribe(menuItems => {
