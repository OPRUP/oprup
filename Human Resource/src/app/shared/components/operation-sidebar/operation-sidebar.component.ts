...
@Component({
  selector: 'app-operation-sidebar',
  templateUrl: './operation-sidebar.component.html',
  styleUrls: ['./operation-sidebar.component.scss']
})
export class OperationSidebarComponent implements OnInit {
  ...
  constructor(
    ...
    this.operationService.items.subscribe(menuItems => {
