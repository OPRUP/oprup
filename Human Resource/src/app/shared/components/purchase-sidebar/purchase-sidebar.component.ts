...
import { Menu, PurchaseNavService } from '../../services/purchase-nav.service';

@Component({
  selector: 'app-purchase-sidebar',
  templateUrl: './purchase-sidebar.component.html',
  styleUrls: ['./purchase-sidebar.component.scss']
})
export class PurchaseSidebarComponent implements OnInit {
  ...
  constructor(
    ...
    private parchaseService : PurchaseNavService,
    ...
    this.parchaseService.items.subscribe(menuItems => {
