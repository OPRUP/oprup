...
@Component({
  selector: 'app-qualified-customer',
  templateUrl: './qualified-customer.component.html',
  styleUrls: ['./qualified-customer.component.scss']
})
export class QualifiedCustomerComponent implements OnInit {
 ...
 chartAccounts;
  ...
  .subscribe(data => {
    this.customer = data;
    this.customer.customerStatus='مؤهل';
