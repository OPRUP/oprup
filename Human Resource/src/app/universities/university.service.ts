...
export class UniversityService {
  ...
  public getUniversityById(universityId: number): Observable<University>{
  ...
  public deleteUniversity(university: University): Observable<University>{
    return this.http.put<University>(`${this.apiServerUrl}/university/delete/`, university);
  }
