...
@ToString
@Entity
@Table(name="CreditNotice")
public class CreditNotice implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "creditNoticeId", nullable = false, updatable = false)
    private long creditNoticeId;

    private String creditNoticeNumber;
    private String creditNoticeType;
    ...
    public long getCreditNoticeId() {
        return creditNoticeId;
    }

    public void setCreditNoticeId(long creditNoticeId) {
        this.creditNoticeId = creditNoticeId;
    }

    public String getCreditNoticeNumber() {
        return creditNoticeNumber;
    }

    public void setCreditNoticeNumber(String creditNoticeNumber) {
        this.creditNoticeNumber = creditNoticeNumber;
    }

    public String getCreditNoticeType() {
        return creditNoticeType;
    }

    public void setCreditNoticeType(String creditNoticeType) {
        this.creditNoticeType = creditNoticeType;
    }
