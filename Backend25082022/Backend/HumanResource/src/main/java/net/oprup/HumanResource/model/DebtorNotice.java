...
@ToString
@Entity
@Table(name="debtorNotice")
public class DebtorNotice implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "debtorNoticeId", nullable = false, updatable = false)
    private long debtorNoticeId;

    private String debtorNoticeNumber;
    private String debtorNoticeType;
    ...
    public long getDebtorNoticeId() {
        return debtorNoticeId;
    }

    public void setDebtorNoticeId(long debtorNoticeId) {
        this.debtorNoticeId = debtorNoticeId;
    }

    public String getDebtorNoticeNumber() {
        return debtorNoticeNumber;
    }

    public void setDebtorNoticeNumber(String debtorNoticeNumber) {
        this.debtorNoticeNumber = debtorNoticeNumber;
    }

    public String getDebtorNoticeType() {
        return debtorNoticeType;
    }

    public void setDebtorNoticeType(String debtorNoticeType) {
        this.debtorNoticeType = debtorNoticeType;
    }
